package com.sif.action.dataCreate;
...
public class PhoneEmailCreate {
    ...
    public void test1(){
        for(int i = 0; i<614; i++){
            System.out.println(PhoneEmailCreate.getTelephone()+'\t'+PhoneEmailCreate.getEmail(5,15));
        }
    }
    ...
    public void test2(){
        for(int i = 0; i<614; i++) {
            ...
            Double temp2;
            if(temp < 0.3) {
                temp2 = new Double((temp+0.5)*1000);
            } else {
                temp2 = new Double(temp*1000);
            }
