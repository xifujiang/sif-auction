...
//            String cid = new String(request.getParameter("cid").getBytes("ISO-8859-1"),"UTF-8");
            ...
            if("1".equals(trade_No.substring(0,1))) {
                depositPayTbService.updateDepositStatus(trade_No, total_amount);
...
//    public String notify123(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException, AlipayApiException {
//        String public_key = "";
//        //获取支付宝GET过来反馈信息
//        Map<String,String> params = new HashMap<String,String>();
//        Map<String,String[]> requestParams = request.getParameterMap();
//        for (Iterator<String> iter = requestParams.keySet().iterator(); iter.hasNext();) {
...
//        }
//
//        boolean signVerified = AlipaySignature.rsaCheckV1(params, public_key, AlipayConfig.charset, AlipayConfig.sign_type); //调用SDK验证签名
//
